    ...
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-6 rounded-3xl border border-neutral-200/90 dark:border-neutral-800/80 bg-gradient-to-br from-white via-slate-50/80 to-white dark:from-neutral-950 dark:via-neutral-900/90 dark:to-neutral-950 shadow-xs relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-600 dark:text-indigo-400 text-[11px] font-semibold tracking-wide uppercase mb-2">
        ...
        <div className="relative z-10 flex flex-wrap items-center gap-3">
          <div className="px-4 py-2 rounded-xl bg-neutral-100/90 dark:bg-neutral-950/80 border border-neutral-200 dark:border-neutral-800 text-xs text-neutral-700 dark:text-neutral-300 shadow-xs">
            <span className="text-neutral-500 dark:text-neutral-400">Active Nodes:</span>{" "}
            <strong className="text-indigo-600 dark:text-indigo-400 font-mono">{activeCount} / {cats.length}</strong>
          </div>
        </div>
      </div>
