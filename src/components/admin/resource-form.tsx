          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  type="button"
                  onClick={() => pasteTo(setThumbnailUrl)}
                  className="text-[10px] text-pink-500 hover:text-pink-400 font-semibold flex items-center gap-1 hover:underline cursor-pointer"
                >
                ...
                {thumbnailUrl && (
                  <button
                    type="button"
                    onClick={() => copyVal(thumbnailUrl, "res-thumb")}
                    className="text-[10px] text-[var(--muted-foreground)] hover:text-pink-400 font-semibold flex items-center gap-1 hover:underline cursor-pointer"
                  >
                    <Copy className="w-3 h-3" /> {copiedKey === "res-thumb" ? "Copied!" : "Copy"}
                  </button>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-1.5">
                ...
                {iconUrl && (
                  <button
                    type="button"
                    onClick={() => copyVal(iconUrl, "res-icon")}
                    className="text-[10px] text-[var(--muted-foreground)] hover:text-pink-400 font-semibold flex items-center gap-1 hover:underline cursor-pointer"
                  >
                    <Copy className="w-3 h-3" /> {copiedKey === "res-icon" ? "Copied!" : "Copy"}
                  </button>
                )}
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1 flex items-center gap-1.5 min-w-0">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-xl border border-[var(--border)] bg-[var(--background)] font-mono text-[var(--foreground)] min-w-0"
                />
                <button
                  type="button"
                  onClick={() => pasteTo((val) => updateDownloadLink(idx, "url", val))}
                  className="px-2.5 py-2 rounded-xl border border-[var(--border)] bg-[var(--background)] hover:bg-[var(--border)] text-pink-500 hover:text-pink-400 text-[11px] font-semibold flex items-center gap-1 flex-shrink-0 cursor-pointer"
                ...
                {link.url && (
                  <button
                    type="button"
                    onClick={() => copyVal(link.url, `res-link-${idx}`)}
                    className="px-2.5 py-2 rounded-xl border border-[var(--border)] bg-[var(--background)] hover:bg-[var(--border)] text-[var(--foreground)] text-[11px] font-semibold flex items-center gap-1 flex-shrink-0 cursor-pointer"
                    title="Copy link to clipboard"
                  >
                    <Copy className="w-3.5 h-3.5" />
                    <span className="hidden sm:inline">
                      {copiedKey === `res-link-${idx}` ? "Copied!" : "Copy"}
                    </span>
                  </button>
                )}
              </div>
